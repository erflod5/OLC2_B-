...
switch (yystate) {
case 1:
 this.$ = { val: $$[$0-1].val}; console.log(s); return this.$; 
break;
case 2:
 s = eval('$$'); this.$ = { val: $$[$0].val}; console.log(s, 'T')
break;
case 3:
 s = eval('$$'); this.$ = { val: s[s.length-4].val + $$[$0].val}; console.log(s, $$[$0-2]);
break;
case 4:
 s = eval('$$'); this.$ = { val: s[s.length-4].val - $$[$0].val}; console.log(s, $$[$0-2]);
break;
case 5:
 s = eval('$$'); this.$ = { val: s[s.length-1].val }; console.log(s, 'Epsilon +');
break;
case 6:
 s = eval('$$'); this.$ = { val: $$[$0].val}; console.log(s, 'F');
break;
case 7:
 s = eval('$$'); this.$ = { val: s[s.length-4].val * $$[$0].val}; console.log(s, $$[$0-2]);
break;
...
break;
case 10: case 11:
 s = eval('$$'); this.$ = { val: Number($$[$0])}; console.log(s, $$[$0]);
break;
case 12:
 s = eval('$$'); this.$ = { val: $$[$0-1].val}; console.log(s, 'E');
break;
}
},
